...
public class ShadowSelectorGenerator {
    ...
    /**
     * Set the dimensions and offsets of the shadow layer. The defaults should work well.
     * @param minShadowOffset the minimum offset for the shadow.
     * @param maxShadowOffset the maximum offset for the shadow.
     * @param minShadowSize the minimum size for the shadow.
    ...
    /**
     * Elevate the view.
     * @param listener an animation listener for the animation.
     * @param duration the duraction of the animation in milliseconds.
     */
